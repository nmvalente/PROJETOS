...
public class RestoreFile extends Ufile
{
	...
	public void list(){
		...
		for (i = 0 ; i < getNChunks() - 1 ; i++){
			//System.out.println( temp.simple() );
			System.out.printf(" [%s] %2d ~ %d , %d\n", ((chunkList[i]) ? "yes" : ".no"), i, chunkList.length, Utils.PARTSIZE);
		}

		int lastpart = getFileSize() - ((getNChunks() - 1) * Utils.PARTSIZE);
